...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    //NSLog(@"%@", @(self.searchDisplayController.searchBar.isFirstResponder));
    if( !self.searchDisplayController.searchBar.isFirstResponder ) self.searchDisplayController.searchBar.alpha = (self.searchDisplayController.searchBar.frame.size.height - scrollView.contentOffset.y)/self.searchDisplayController.searchBar.frame.size.height;
